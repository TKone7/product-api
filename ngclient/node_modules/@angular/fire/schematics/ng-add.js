...
exports.ngAdd = (options) => (host, context) => {
    ...
    Object.keys(versions_json_1.default).forEach(name => {
        const dev = versions_json_1.default[name].dev;
        const dependencies = dev ? packageJson.devDependencies : packageJson.dependencies;
        dependencies[name] = dependencies[name] || versions_json_1.default[name].version;
    });
