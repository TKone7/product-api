(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('@angular/core'), require('@angular/fire')) :
    typeof define === 'function' && define.amd ? define('@angular/fire/storage', ['exports', 'rxjs', 'rxjs/operators', '@angular/core', '@angular/fire'], factory) :
    ...
    function createStorageRef(ref, schedulers, keepUnstableUntilFirst) {
        return {
             ...
             * @return {?}
             */
            function () { return rxjs.from(ref.getDownloadURL(), schedulers.outsideAngular).pipe(keepUnstableUntilFirst); }),
            getMetadata: (/**
             * @return {?}
             */
            function () { return rxjs.from(ref.getMetadata()).pipe(keepUnstableUntilFirst); }),
            delete: (/**
             * @return {?}
             */
