...
function deploy(firebaseTools, context, projectRoot, buildTarget, firebaseProject) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const run = yield context.scheduleTarget(architect_1.targetFromTargetString(buildTarget));
        yield run.result;
        try {
        ...
        try {
            const success = yield firebaseTools.deploy({
